"""
Django settings for docmaker project.
...
SECRET_KEY = 'django-insecure-k5crsk(7!rp_m&2%ta540-)gzyqorc9dgb0^wgmw7h-6u$%!ej'
...
WSGI_APPLICATION = 'docmaker.wsgi.application'
